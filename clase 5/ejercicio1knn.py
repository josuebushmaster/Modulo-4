...
df_train = pd.read_excel(str(base / "TitanicTraining.xlsx"))
df_predict = pd.read_excel(str(base / "TitanicPredecir.xlsx"))
...
# Construir pipeline con imputador, escalador y KNN
pipeline = Pipeline([
...
# Prediccion
predicciones = pipeline.predict(df_predict_copia)
...
output_file = str(base / "Resultados_Prediccion_knn.xlsx") # Nombre del archivo de salida (en la misma carpeta que el script)
